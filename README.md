...
```html
<script src="https://cdn.jsdelivr.net/npm/databridges-sio-js-lib@2.0.2/dist/databridges.sio.lib.min.js" integrity="sha384-M7evb/lzD8eSwiyBjZID0EhnKjDlCt/Ijep4JaEFEBGiQPqDYwaF+SOyliAJUWzv" crossorigin="anonymous"></script>
```

- **unpkg** :

```html
<script src="https://unpkg.com/databridges-sio-js-lib@2.0.2/dist/databridges.sio.lib.min.js" integrity="sha384-M7evb/lzD8eSwiyBjZID0EhnKjDlCt/Ijep4JaEFEBGiQPqDYwaF+SOyliAJUWzv" crossorigin="anonymous"></script>
```
